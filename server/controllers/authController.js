...
export const register = async (req, res) => {
                        ...
                        try {
                            ...
                            const token = jwt.sign({id: user._id}, process.env.JWT_SECRET, {expiresIn: '7d'}) // whenever a new user create it is created using ._id, the jwt token is generated and it is validated for 7 days 
